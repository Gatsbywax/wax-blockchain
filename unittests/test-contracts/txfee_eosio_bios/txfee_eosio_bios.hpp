...
namespace eosio {
   namespace internal_use_do_not_use {
      extern "C" {
         ...
         __attribute__((eosio_wasm_import))
         void set_fee_limits( uint64_t account, int64_t net_weight_limit, int64_t cpu_weight );
...
namespace eosio {
   ...
   void set_fee_limits( name account, int64_t net_weight_limit, int64_t cpu_weight ) {
      internal_use_do_not_use::set_fee_limits( account.value, net_weight_limit, cpu_weight );
   }
}
...
namespace eosio {
    ...
    * @{
    */
   class [[eosio::contract("txfee_eosio_bios")]] bios : public contract {
      public:
          ...
          */
         [[eosio::action]]
         void setfeeparams( uint64_t cpu_fee_scaler, uint64_t free_block_cpu_threshold, uint64_t net_fee_scaler, uint64_t free_block_net_threshold );
          ...
          *
          * @param account - name of the account whose resource limit to be set
          * @param tx_fee_limit - ram limit in absolute bytes
          * @param net_weight - fractionally proportionate net limit of available resources based on (weight / total_weight_of_all_accounts)
          * @param cpu_weight - fractionally proportionate cpu limit of available resources based on (weight / total_weight_of_all_accounts)
          */
         [[eosio::action]]
         void cfgfeelimits( name account, int64_t tx_fee_limit, int64_t account_fee_limit);
         
         /**
          * Set the fee limits for an account.
          *
          * @details Set the fee limits for an account.
          *
          * @param account - name of the account whose resource limit to be set.
         ...
         */
         [[eosio::action]]
         void setfeelimits( name account, int64_t net_weight_limit, int64_t cpu_weight_limit );
         ...
         using cfgfeelimits_action = action_wrapper<"cfgfeelimits"_n, &bios::cfgfeelimits>;
         using setfeelimits_action = action_wrapper<"setfeelimits"_n, &bios::setfeelimits>;
   };
