...
public:
   ...
   void on_init_resource_fees_config(const resource_limits::resource_fees_config_object& fees_config);
   ...
   void on_update_resource_fees_config(const resource_limits::resource_fees_config_object& fees_config);
   ...
   void on_init_account_fees_limits(const resource_limits::resource_fees_object& fees_limits);
   void on_update_account_fees_limits(const resource_limits::resource_fees_object& fees_limits);   
